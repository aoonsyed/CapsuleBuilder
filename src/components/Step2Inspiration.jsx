        ...
        <div className="mx-auto max-w-[560px] rounded-[34px] bg-[#F2EFEA] shadow-[0_20px_60px_rgba(0,0,0,0.10)] px-10 py-12">
          <form onSubmit={handleSubmit} className="space-y-11 text-[#2B2A25]">
            ...
            <div className="mt-10 flex items-center justify-between">
              ...
              <button type="submit" className="relative h-[52px] w-[248px] rounded-full bg-[#2B2A25] text-white">
                <span className="block w-full text-center font-sans text-[12px] tracking-[0.24em] uppercase">CONTINUE TO STEP 3</span>
