        ...
        {!embedded && (
          <div className="flex items-center justify-between gap-4 mt-8">
            <button
              type="button"
              onClick={onBack}
              className="px-6 py-3 text-[14px] font-sans font-medium leading-[1.2] text-white bg-[#3A3A3D] hover:bg-black active:bg-[#1C1C1C] rounded-md shadow transition duration-200"
            >
              ← Back
            </button>
            <button
