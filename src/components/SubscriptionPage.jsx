...
export default function SubscriptionPage({ onBack }) {
  return (
    <div>
      ...
      <button
        onClick={onBack}
        className="text-sm text-black hover:underline hover:text-black mr-200 "
      >
        ← Back
      </button>
      </div>
    <div className="flex justify-center gap-4 p-8">
      ...
      <div className="flex items-center">
        <div className="bg-white/80 rounded-2xl shadow-lg border border-[#E4E4E4] w-[300px] h-[400px] overflow-hidden flex flex-col transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl">
          ...
          <h2 className="text-lg font-semibold text-black p-4 border-b border-gray-200">
            Tier 1:
          </h2>
          ...
          <div className="flex-grow  ">
            ...
            <span className="text-gray-500"><ul className="text-black text-m space-y-3 x-3 ml-5">
              <li><strong className='text-lg'>$29–$49/month</strong> <ul className="list-disc list-inside ml-4 mt-1 text-m">
     ...
     <div className="flex items-center">
        <div className="bg-white/80 rounded-2xl shadow-lg border border-[#E4E4E4]  w-[300px] h-[400px] overflow-hidden flex flex-col transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl">
          ...
          <div className="flex-grow">
            <span className="text-gray-500"><ul className="text-black text-m space-y-3 x-3 ml-5">
           <li><strong className="text-black">$99–$299/month</strong><ul className="list-disc list-inside ml-4 mt-1 text-black text-m">
...
{/*Card 3 */}
      <div className="flex items-center">
        <div className="bg-white/80 rounded-2xl shadow-lg border border-[#E4E4E4] w-[300px] h-[400px] overflow-hidden flex flex-col transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl">
          ...
          <div className="flex-grow">
            <span className="text-gray-500"><ul className="text-black text-m space-y-3 x-3 ml-5">
           <li><strong className="text-black">$199–$299/month</strong><ul className="list-disc list-inside ml-4 mt-1 text-black text-m">
      <li>Access to templates</li>
      <li>Basic AI sketching</li>
      <li>Early-stage idea mapping</li>
    </ul></li>
      ...
      <div className="flex items-center">
        <div className="bg-white/80 rounded-2xl shadow-lg border border-[#E4E4E4] w-[300px] h-[400px] overflow-hidden flex flex-col transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl">
          ...
          <div className="flex-grow">
            <ul className=" text-m space-y-3 list-disc list-inside text-black ml-6">
  <li>
