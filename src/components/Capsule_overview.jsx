...
export default function CapsuleOverview() {
  return (
    <div className="w-screen relative left-1/2 -ml-[50vw] bg-[#333333] font-sans overflow-x-hidden">
      <div className="max-w-4xl mx-auto text-center py-10 md:py-12 px-4">
        <h1 className="text-white font-extralight text-[24pt] sm:text-[28pt] md:text-[30pt] font-heading mb-8 md:mb-12 leading-[1.2]">
          WHAT YOU'LL RECEIVE
        </h1>

        <h1 className="text-white text-[13pt] font-heading font-semibold leading-[1.2] mt-2">Curated Materials</h1>
        <p className="text-white/90 text-[12pt] font-sans mb-5 leading-[1.2]">
          Thoughtfully Selected Fabrics Tailored to your Aesthetic, Function And Brand Goals.
        </p>

        <h1 className="text-white text-[13pt] font-heading font-semibold leading-[1.2] mt-2">Color Direction</h1>
        <p className="text-white/90 text-[12pt] font-sans mb-5 leading-[1.2]">
          A Color Palette Shaped By Your Feedback And Market Position.
        </p>

        <h1 className="text-white text-[13pt] font-heading font-semibold leading-[1.2] mt-2">Design Framework</h1>
        <p className="text-white/90 text-[12pt] font-sans mb-5 leading-[1.2]">
          A Strategic Breakdown Of Categories And Silhouettes Aligned With Your Vision.
        </p>

        <h1 className="text-white text-[13pt] font-heading font-semibold leading-[1.2] mt-2">Cost Transparency</h1>
        <p className="text-white/90 text-[12pt] font-sans mb-5 leading-[1.2]">
      ...
      <div className="w-screen bg-[#EDEDED] pt-8 md:pt-10 pb-10 md:pb-12 overflow-x-hidden">
        <div className="text-center px-4">
          <h1 className="font-heading text-[24pt] sm:text-[28pt] md:text-[30pt] text-black mb-4 md:mb-5 leading-[1.2]">WHO IT’S FOR</h1>
          <p className="text-[#000000] text-[16px] md:text-[17px] font-sans leading-[1.2] px-0 md:px-4 mb-1">
