    ...
    return (
        <div className="max-w-2xl mx-auto p-8 border border-white bg-white/60 backdrop-blur-md rounded-lg shadow-lg font-sans max-h-[90vh] overflow-y-auto overflow-x-hidden" style={{ scrollbarWidth: 'thin', scrollbarColor: '#888 #f1f1f1' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 text-black">
                ...
                <div>
                    ...
                    <div className="space-x-6">
                        <label className="inline-flex items-center">
                            ...
                            />
                            <span className="ml-2 text-[14px] font-sans font-medium leading-[1.2]">Yes</span>
                        </label>
                        ...
                        <label className="inline-flex items-center">
                            <input
                                ...
                                className="accent-[#3A3A3D]"
                            />
                            <span className="ml-2 text-[14px] font-sans font-medium leading-[1.2]">No</span>
                        </label>
                    </div>

                    {materialError && <p className="text-[14px] font-sans font-medium leading-[1.2] text-red-600 mt-2">Please select Yes or No to proceed.</p>}

                    {materialPreferenceOptions?.yes && (
                        <input
                            className="w-full mt-4 border border-black bg-transparent px-5 py-3 text-[14px] font-sans font-medium leading-[1.2] text-black placeholder-black/40 focus:outline-none rounded-md"
                ...
                <div>
                    <p className="text-[14px] font-sans font-medium leading-[1.2] mb-2">Manufacturing preference:</p>
                    <div className="space-x-6">
                        <label className="inline-flex items-center">
                            <input
                                type="checkbox"
                                ...
                                className="accent-[#3A3A3D]"
                            />
                            <span className="ml-2 text-[14px] font-sans font-medium leading-[1.2]">USA</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input
                                type="checkbox"
                                ...
                                className="accent-[#3A3A3D]"
                            />
                            <span className="ml-2 text-[14px] font-sans font-medium leading-[1.2]">International</span>
                        </label>
                    </div>
                </div>
